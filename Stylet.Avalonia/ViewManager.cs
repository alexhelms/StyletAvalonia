...
public interface IViewManager
{
    ...
    //void OnModelChanged(AvaloniaObj targetLocation, object oldValue, object newValue);
...
public class ViewManager : IViewManager
{
    ...
    ///// <param name="oldValue">Previous value of View.Model</param>
    ///// <param name="newValue">New value of View.Model</param>
    //public virtual void OnModelChanged(AvaloniaObj targetLocation, object oldValue, object newValue)
    //{
    ...
    {
        var types = this.ViewAssemblies.Concat(extraAssemblies).Select(x => x.GetType(viewName));
        return types.FirstOrDefault(x => x != null);
    }
